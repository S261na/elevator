...
//запрашиваем у пользователя нужный лифт
...
//реализуем перемещение лифта при нажатии нужной кнопки
...
// let currentPosition = elevator.getBoundingClientRect().top;
